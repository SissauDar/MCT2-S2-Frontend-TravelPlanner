...
const showCountries = data => {
  ...
  for (const c of data) {
    countries += `
        <article>
            <input type="checkbox" class="o-hide c-country-input" id="${c.cioc}-${c.alpha2Code}"
            ...
            <label for="${c.cioc}-${c.alpha2Code}" class="c-country js-country" data-country-name="${c.name}">
                <div class="c-country-header">
                    ...
                    <img src="${c.flag}" alt="The flag of ${c.name}" class="c-country-header__flag">
                </div>
